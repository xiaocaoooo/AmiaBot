...
.PHONY: build test fmt clean tidy \
	build-screenshot build-blobserver build-bilibili build-pixiv build-account build-bind build-card build-event build-song build-profile build-b30 build-query build-zeabur build-gallery build-onebot-websocket-client
...
build-gallery: $(BIN_DIR)/nyanyabot-plugin-amiabot-gallery
build-onebot-websocket-client: $(BIN_DIR)/nyanyabot-plugin-amiabot-onebot-websocket-client
