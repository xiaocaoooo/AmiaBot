...
fn plugin_descriptor() -> Descriptor {
    Descriptor {
        name: "Amiabot PJSK B30".into(),
        plugin_id: "external.amiabot-pjsk-b30".into(),
        version: "0.1.0".into(),
        author: "nyanyabot".into(),
        description: "PJSK B30 查询插件，发送 b30 截图".into(),
        dependencies: vec![
        ...
        config: Some(ConfigSpec {
            version: Some("1".into()),
            description: Some("Amiabot PJSK B30 plugin config".into()),
            schema: Some(json!({
                "type":"object",
                "properties":{
