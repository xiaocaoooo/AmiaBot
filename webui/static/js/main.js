...
class NavigationManager {
    ...
    navigateTo(targetId, updateHistory = true) {
        ...
        if (this.pageNameElement) {
            const linkText = (_a = Array.from(this.navLinks).find(link => link.getAttribute('href') === `#${targetId}` || link.getAttribute('data-id') === targetId)) === null || _a === void 0 ? void 0 : _a.textContent;
        ...
        this.navLinks.forEach(link => {
            var _a;
            const linkTargetId = ((_a = link.getAttribute('href')) === null || _a === void 0 ? void 0 : _a.substring(1)) || link.getAttribute('data-id') || '';
